...
const CreateInvoiceModal = ({ schoolId, onSave }) => {
  ...
  const handleChange = (e) => {
    ...
    const parsedValue = name === "amount" || name === "paid_amount" ? parseFloat(value) : value;
  ...
  return (
    <>
      ...
      {showModal && (
    <div
    className="modal" tabIndex="-1" role="dialog" style={{ display: "block", backgroundColor: "rgba(0, 0, 0, 0.5)" }}>
